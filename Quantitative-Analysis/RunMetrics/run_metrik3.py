#!/usr/bin/env python3
"""Run Metrik-3 over the dataset and save Quantitative-Analysis/Results/results_metrik3.json.

Metrik-3 is a UCG-based structural metric. The S2 module ``metric.py`` takes
...
def main() -> int:
    ...
    adapter = _Metrik3Adapter(metric_module)
    ...
    workflow.run()
    output = workflow.save("results_metrik3.json")
