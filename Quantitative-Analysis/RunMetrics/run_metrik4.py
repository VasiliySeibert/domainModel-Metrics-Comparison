#!/usr/bin/env python3
"""Run Metrik-4 over the dataset using a process pool.

The S-1 metric underlying Metrik-4 is expensive (NLTK / WordNet graph
...
def main() -> int:
    ...
    output_path = RESULTS_DIR / "results_metrik4.json"
